// Generated from pinned Node sources by scripts/vendor-node-inspection.mjs.
...
[
  ...
  // eslint-disable-next-line no-restricted-globals
  // The WASM engine has no Atomics. Inspection does not use it.
...
return primordials;};
exports.factories={"internal/util/inspect":function(module,exports,require,primordials,internalBinding,process){
'use strict';
...
"internal/assert":function(module,exports,require,primordials,internalBinding,process){
'use strict';
...
"internal/util":function(module,exports,require,primordials,internalBinding,process){
const {
  ArrayFrom,
  ArrayPrototypePush,
  ArrayPrototypeSlice,
...
"internal/errors":function(module,exports,require,primordials,internalBinding,process){
const {
  AggregateError,
  ArrayIsArray,
  ArrayPrototypeFilter,
...
const assert=require('internal/assert');
messages.set("ERR_INTERNAL_ASSERTION",(message) => {
...
codes.ERR_INTERNAL_ASSERTION=makeNodeErrorWithCode(Error,"ERR_INTERNAL_ASSERTION");
...
codes.ERR_INVALID_ARG_TYPE=makeNodeErrorWithCode(TypeError,"ERR_INVALID_ARG_TYPE");
codes.ERR_INVALID_ARG_TYPE.HideStackFramesError=makeNodeErrorForHideStackFrame(codes.ERR_INVALID_ARG_TYPE,TypeError);
module.exports={codes,isStackOverflowError,hideStackFrames};
},
"internal/validators":function(module,exports,require,primordials,internalBinding,process){
const {codes:{ERR_INVALID_ARG_TYPE:{HideStackFramesError:ERR_INVALID_ARG_TYPE}},hideStackFrames}=require('internal/errors');
const {
  ArrayIsArray,
  ArrayPrototypeIncludes,
  ArrayPrototypeJoin,
